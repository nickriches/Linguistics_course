...
Grammatical aspect refers to `r mcq(c("when an event happened in relation to the time of speaking", answer = "our perspective on an event, e.g. internal versus external", "the inherent temporal properties of a verb"))`. It is expressed using the `r mcq(c(answer = "present participle (-ing form)", "past participle"))` to signal an internal perspective, and the `r mcq(c("present participle (-ing form)", answer = "past participle"))` to signal an external perspective (i.e. a completed event).
