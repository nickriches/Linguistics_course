...
Click [here](other/Semester 1 - mock exam.docx) to download the mock exam. [This](docs/other/LARSP symbols.pdf) is the list of symbols you will be given to use in the exam.
  
## MScs

MScs will do the **exam in Semester 2 only** (May 2019). At the end of Semester 1, you will do a [Semantic Analysis exercise](other/MSc Semantic Analysis Exercise.docx) (analysing the argument structure of sentences in clinical data). The motivation for this additional assessment is that this is an important topic which does not appear in the Semester 2 exam
